...
# detector = cv2.CascadeClassifier('E:\\Projects\\Examix project\\backend\\face_detection\\trainer\\trainer.yml')
# recognizer = cv2.face.LBPHFaceRecognizer_create()

# detector = cv2.CascadeClassifier(
#     BASE_DIR+'/Face_Detection/haarcascade_frontalface_default.xml')
# recognizer = cv2.face.LBPHFaceRecognizer_create()
...
# # Create a connection witn database
...
class FaceRecognition:
    ...
    def faceDetect(self, Entry1,):
        ...
        while (True):
            ...
            for (x, y, w, h) in faces:
                ...
                cv2.imwrite(BASE_DIR+'/dataset/User.' +
    ...
    def trainFace(self):
        ...
        recognizer.save(BASE_DIR+'/trainer/trainer.yml')
